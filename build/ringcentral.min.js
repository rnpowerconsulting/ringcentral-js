!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require(void 0),require("es6-promise"),require("fetch-ponyfill")):"function"==typeof define&&define.amd?define(["pubnub","es6-promise","fetch-ponyfill"],t):"object"==typeof exports?exports.SDK=t(require(void 0),require("es6-promise"),require("fetch-ponyfill")):(e.RingCentral=e.RingCentral||{},e.RingCentral.SDK=t(e[void 0],e["es6-promise"],e["fetch-ponyfill"]))}(this,function(e,t,r){return function(e){function t(n){if(r[n])return r[n].exports;var s=r[n]={exports:{},id:n,loaded:!1};return e[n].call(s.exports,s,s.exports,t),s.loaded=!0,s.exports}var r={};return t.m=e,t.c=r,t.p="/build/",t(0)}([function(e,t,r){function n(e){this._externals=new a(e),this._cache=new i({externals:this._externals,cachePrefix:e.cachePrefix}),this._client=new o(this._externals),this._platform=new h(s({},e,{externals:this._externals,client:this._client,cache:this._cache}))}var s=r(1),i=r(2),o=r(3),a=r(11),h=r(15),c=r(19),u=r(20),p=r(17);n.version=p.version,n.server={sandbox:"https://platform.devtest.ringcentral.com",production:"https://platform.ringcentral.com"},n.prototype.platform=function(){return this._platform},n.prototype.cache=function(){return this._cache},n.prototype.createSubscription=function(e){return new c(s({},e,{externals:this._externals,platform:this._platform}))},n.prototype.createCachedSubscription=function(e){return e="string"==typeof arguments[0]?{cacheKey:arguments[0].toString()}:e||{},new u(s({},e,{externals:this._externals,platform:this._platform,cache:this._cache}))},n.handleLoginRedirect=function(e){var t=window.location.hash?window.location.hash:window.location.search,r={};r[p.authResponseProperty]=t,window.opener.postMessage(r,e||window.location.origin)},e.exports=n},function(e,t){"use strict";function r(e){if(null===e||void 0===e)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function n(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de","5"===Object.getOwnPropertyNames(e)[0])return!1;for(var t={},r=0;r<10;r++)t["_"+String.fromCharCode(r)]=r;var n=Object.getOwnPropertyNames(t).map(function(e){return t[e]});if("0123456789"!==n.join(""))return!1;var s={};return"abcdefghijklmnopqrst".split("").forEach(function(e){s[e]=e}),"abcdefghijklmnopqrst"===Object.keys(Object.assign({},s)).join("")}catch(i){return!1}}var s=Object.prototype.hasOwnProperty,i=Object.prototype.propertyIsEnumerable;e.exports=n()?Object.assign:function(e,t){for(var n,o,a=r(e),h=1;h<arguments.length;h++){n=Object(arguments[h]);for(var c in n)s.call(n,c)&&(a[c]=n[c]);if(Object.getOwnPropertySymbols){o=Object.getOwnPropertySymbols(n);for(var u=0;u<o.length;u++)i.call(n,o[u])&&(a[o[u]]=n[o[u]])}}return a}},function(e,t){function r(e){this._prefix=e.prefix||r.defaultPrefix,this._externals=e.externals}r.defaultPrefix="rc-",r.prototype.setItem=function(e,t){return this._externals.localStorage[this._prefixKey(e)]=JSON.stringify(t),this},r.prototype.removeItem=function(e){return delete this._externals.localStorage[this._prefixKey(e)],this},r.prototype.getItem=function(e){var t=this._externals.localStorage[this._prefixKey(e)];return t?JSON.parse(t):null},r.prototype.clean=function(){for(var e in this._externals.localStorage)this._externals.localStorage.hasOwnProperty(e)&&0===e.indexOf(this._prefix)&&delete this._externals.localStorage[e];return this},r.prototype._prefixKey=function(e){return this._prefix+e},e.exports=r},function(e,t,r){function n(e,t){return e=e.toLowerCase(),Object.keys(t).reduce(function(t,r){return t?t:e==r.toLowerCase()?r:t},null)}function s(e){o.call(this),this._externals=e,this.events={beforeRequest:"beforeRequest",requestSuccess:"requestSuccess",requestError:"requestError"}}var i=r(4),o=r(6).EventEmitter,a=r(7),h=r(8);s._allowedMethods=["GET","POST","PUT","DELETE","PATCH","OPTIONS","HEAD"],s.prototype=Object.create(o.prototype),s.prototype.sendRequest=function(e){var t=new a({externals:this._externals,request:e});return new this._externals.Promise(function(r){this.emit(this.events.beforeRequest,t),r(this._loadResponse(e))}.bind(this)).then(function(e){return t.receiveResponse(e)}).then(function(){if(!t.ok())throw new Error("Response has unsuccessful status");return this.emit(this.events.requestSuccess,t),t}.bind(this))["catch"](function(e){throw e.apiResponse||(e=this.makeError(e,t)),this.emit(this.events.requestError,e),e}.bind(this))},s.prototype._loadResponse=function(e){return this._externals.fetch.call(null,e.url,e)},s.prototype.makeError=function(e,t){return e.hasOwnProperty("apiResponse")||e.hasOwnProperty("originalMessage")||(e.apiResponse=t,e.originalMessage=e.message,e.message=t&&t.error(!0)||e.originalMessage),e},s.prototype.createRequest=function(e){if(e=e||{},e.headers=e.headers||{},!e.url)throw new Error("Url is not defined");if(e.method||(e.method="GET"),e.method=e.method.toUpperCase(),e.method&&s._allowedMethods.indexOf(e.method)<0)throw new Error("Method has wrong value: "+e.method);if(e.credentials=e.credentials||"include",e.mode=e.mode||"cors",e.query&&(e.url=e.url+(e.url.indexOf("?")>-1?"&":"?")+h.stringify(e.query)),n("Accept",e.headers)||(e.headers.Accept=a._jsonContentType),i(e.body)||!e.body){var t=n(a._contentType,e.headers);t||(t=a._contentType,e.headers[t]=a._jsonContentType);var r=e.headers[t];r.indexOf(a._jsonContentType)>-1?"GET"!==e.method&&"HEAD"!==e.method||!e.body?e.body=JSON.stringify(e.body):e.body=void 0:r.indexOf(a._urlencodedContentType)>-1&&(e.body=h.stringify(e.body))}var o=new this._externals.Request(e.url,e);return o.originalBody=e.body,o},e.exports=s},function(e,t,r){/*!
